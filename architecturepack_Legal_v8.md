# Architecture Pack - Legal Workflow System v8

> Project: **Legal**
> Date: 2026-03-31
> Version: v8 - SEC Permission System, Task Reassignment, GCS Storage, LF210/LF240 updates
...
|---|--------|------|----------|----------|
| 1 | SEC Permission System | TÍCH HỢP | S1.1, S1.3(mới), S4, S5, S6 | Tích hợp hệ thống phân quyền SEC 4 cấp (BigQuery, Google SSO, 459 user @apero.vn) |
| 2 | Task Reassignment (Droplist) | TÍNH NĂNG MỚI | S1.1, S3, S4, S5, S6 | Dropdown chuyển task cho checker/approver khác. Event type REASSIGN |
| 3 | GCS Document Storage | NÂNG CẤP | S1.1, S5, S6, S7 | Chuyển lưu trữ file từ local sang Google Cloud Storage buckets |
| 4 | Event Log Positioning | UI | S3 | Di chuyển Event Log xuống cuối trang (dưới Actions) |
| 5 | LF210 Create Task Changes | SỬa ĐỔI | S2, S3, S6 | Bỏ Urgency/LE/CTY; thêm CDT; bắt buộc Product Code/Name; thêm nút Upload |
| 6 | LF240 Additional Fields | TÍNH NĂNG MỚI | S1.1, S2, S3, S5, S6 | 7 trường input mới cho LF240 IN_PROGRESS (SĐT, email, mục đích, mã PE) |
| 7 | Cloud SQL PostgreSQL | NANG CAP | S6.5, S7.6(moi) | Chuyen SQLite ephemeral sang Cloud SQL PostgreSQL persistent. Dual-backend wrapper |
| 8 | Document Link URL | TINH NANG MOI | S1.1, S3, S6.3 | Them field `link_url` vao TDI. View mo external link, Download tai file dinh kem |
| 9 | ProcessDescription Enrichment | CAP NHAT | S2 | Bo sung chi tiet khai niem, dieu kien, logic cho tung quy trinh LF210-LF240 |
| 10 | Product-level Grouping | THIET KE MOI | S1.1, S2.1, S3.4 | Them tang Product (L0) tren TST L1. My Tasks gom theo san pham |
| 11 | LF234 Ban noti ASO | SUA DOI | S2.4 | Doi LF234 tu Dang len Store thanh Ban noti cho ASO |
| 12 | Bo LF245 Trinh ky | SUA DOI | S2.5 | Bo step trinh ky phe duyet. LF246->LF245, LF247->LF246 |
| 13 | Role User -> Submitters | SUA DOI | Toan bo | Doi ten role User thanh Submitters |
